...
} from '../../../core/services/student-dashboard-data.service';
...
export class StudentDashboardComponent implements OnInit {
  ...
  academicSummary = computed(() => this.dashboardData()?.academicSummary);
  ...
  constructor(
    private readonly studentDashboardDataService: StudentDashboardDataService,
  ...
  loadDashboardData(): void {
    ...
    this.studentDashboardDataService.getDashboardData().subscribe({
      next: (data) => {
        this.dashboardData.set(data);
        this.isLoading.set(false);
      },
      error: () => {
        this.serverError.set('Failed to load student dashboard data.');
        this.isLoading.set(false);
      },
    });
  }
  ...
  formatEventDate(event: StudentDashboardEventItem): string {
  ...
  formatEventTime(event: StudentDashboardEventItem): string {
